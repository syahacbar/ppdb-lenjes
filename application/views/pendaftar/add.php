    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Pendaftar Add</h3>
            </div>
            <?php echo form_open('pendaftar/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="jenkel" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('jenkel')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="namapendaftar" value="<?php echo $this->input->post('namapendaftar'); ?>" class="form-control" id="namapendaftar" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tgllahir" value="<?php echo $this->input->post('tgllahir'); ?>" class="has-datepicker form-control" id="tgllahir" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="alamatlengkap" value="<?php echo $this->input->post('alamatlengkap'); ?>" class="form-control" id="alamatlengkap" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kodealamat" value="<?php echo $this->input->post('kodealamat'); ?>" class="form-control" id="kodealamat" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="namaayah" class="control-label"><span class="text-danger">*</span>Namaayah</label>
						<div class="form-group">
							<input type="text" name="namaayah" value="<?php echo $this->input->post('namaayah'); ?>" class="form-control" id="namaayah" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="namaibu" value="<?php echo $this->input->post('namaibu'); ?>" class="form-control" id="namaibu" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="pekerjaanayah" value="<?php echo $this->input->post('pekerjaanayah'); ?>" class="form-control" id="pekerjaanayah" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="pekerjaanibu" value="<?php echo $this->input->post('pekerjaanibu'); ?>" class="form-control" id="pekerjaanibu" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nomorhp" value="<?php echo $this->input->post('nomorhp'); ?>" class="form-control" id="nomorhp" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="asalsekolah" value="<?php echo $this->input->post('asalsekolah'); ?>" class="form-control" id="asalsekolah" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="filefoto" value="<?php echo $this->input->post('filefoto'); ?>" class="form-control" id="filefoto" />
						</div>
					</div>
				</div>
			</div>
