...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('resources/themes/multistepform/bootstrap/css/bootstrap.min.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('resources/themes/multistepform/font-awesome/css/font-awesome.min.css');?>">
		<link rel="stylesheet" href="<?php echo base_url('resources/themes/multistepform/css/form-elements.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('resources/themes/multistepform/css/style.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('resources/themes/multistepform/css/media-queries.css');?>">
    ...
    <body>
	        ...
	        <div class="container">
	        	<div class="row">
	                <div class="col-sm-12 description-title">
	                    <h2>Bootstrap Long Multi Step Form</h2>
	                </div>
	            </div>
	            <div class="row">
        ...
        <!-- Javascript -->
        <script src="<?php echo base_url('resources/themes/multistepform/js/jquery-1.11.1.min.js');?>"></script>
        <script src="<?php echo base_url('resources/themes/multistepform/bootstrap/js/bootstrap.min.js');?>"></script>
        <script src="<?php echo base_url('resources/themes/multistepform/js/jquery.backstretch.min.js');?>"></script>
        <script src="<?php echo base_url('resources/themes/multistepform/js/scripts.js');?>"></script>
